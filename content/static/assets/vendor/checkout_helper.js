(function () {
  ...
  forms.forEach( function(e) {
    e.addEventListener('submit', function(event) {
      ...
      let pay_id = formData.get("pay_id");

      php_email_form_submit(thisForm, action, formData, name, phone, email, order_id, pay_id);
    });
  });
  ...
  function php_email_form_submit(thisForm, action, formData, name, phone, email, order_id, pay_id) {
    let options =
                {
                    "key": pay_id,
                    "name": "ShelterSearch",
